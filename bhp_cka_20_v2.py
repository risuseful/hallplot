...
#       - output file: out_pred_cka20.csv. With columns -> Date, Q_STBD, THP_PSIA, BHP_PSIA, cum_Q_STB, cum_BHP_PSIA

# construct SQL query
# query = "SELECT cast([TIMESTAMP] as Date) as Date ,[VOL_INJ_CK20] as Q_STBD ,([INJ_BP_CK20]*14.5+14.7) as THP_PSIA " # in PSIA
